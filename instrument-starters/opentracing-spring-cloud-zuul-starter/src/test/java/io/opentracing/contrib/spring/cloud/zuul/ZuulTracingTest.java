...
@SpringBootTest(
    ...
    properties = {
        "zuul.routes.test.url=http://localhost:53751/hello",
...
public class ZuulTracingTest {
  ...
  public void testZuulTracing() {
    testRestTemplate.getForEntity("/test", String.class);
  ...
  public void testWrongZuulRoute() {
    testRestTemplate.getForEntity("/wrong", String.class);
  ...
  public void testWrongZuulRoutePort() {
    testRestTemplate.getForEntity("/wrong-port", String.class);
