...
import io.opentracing.contrib.jdbc.TracingConnectionWrapper;
...
public class JdbcAspect {
  ...
  public Object getConnection(final ProceedingJoinPoint pjp) throws Throwable {
    ...
    return new TracingConnectionWrapper(conn, connectionInfo, withActiveSpanOnly, ignoredStatements, GlobalTracer.get());
  }
}
